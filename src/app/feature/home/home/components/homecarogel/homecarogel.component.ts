...
@Component({
  selector: 'app-homecarogel',
  templateUrl: './homecarogel.component.html',
  styleUrls: ['./homecarogel.component.scss']
})
export class HomecarogelComponent implements OnInit {
// Array of object for OurMenu Code HTML Here
// @ViewChild(' deleteModal')  takeAway;
// private takeAwayRef;
public ourMenuArray = [{
...
//   private modalService: ModalManager) { }
  ...
  //   openTakeAwayModal() {
  //    this.takeAwayRef = this.open(this.takeAway, {
  //      size: "md",
  //    })
  //  }
}
